    ...
    <div>
      ...
      <div className="align-items-center flex-row flex-fill fs-5 no-wrap-btn flex-nowrap d-flex">
        ...
        <span className="d-flex flex-grow-1">
            <span className="red-icon mx-2">{coursesTitle}</span> &gt; <span className="red-icon mx-2">{course.name}</span> &gt; <span className={`mx-2 ${assignmentId != null && "red-icon" }`}>{screen}</span> <span>{assignmentId != null ? "> " + assignmentId : ""}</span>
        </span>
